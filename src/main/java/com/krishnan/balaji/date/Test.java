package com.krishnan.balaji.date;
...
public class Test {
	...
	public static void main(String[] args) {
		...
		// Clock
		/*
		 * Clock provides access to the current date and time. Clocks are aware
		 * of a timezone and may be used instead of System.currentTimeMillis()
		 * to retrieve the current milliseconds. Such an instantaneous point on
		 * the time-line is also represented by the class Instant. Instants can
		...
		// LocalTime
		/*
		 * LocalTime represents a time without a timezone, e.g. 10pm or
		...
		/*
		 * LocalTime comes with various factory method to simplify the creation
		 * of new instances, including parsing of time strings.
		 */
		...
		// LocalDate
		/*
		 * LocalDate represents a distinct date, e.g. 2014-03-11. It's immutable
		...
		// Parsing a LocalDate from a string is just as simple as parsing a
		// LocalTime:
		 ...
		 * immutable and works similar to LocalTime and LocalDate. We can
		...
		/*
		 * With the additional information of a timezone it can be converted to
		 * an instant. Instants can easily be converted to legacy dates of type
		 * java.util.Date.
		 */
		...
		// Unlike java.text.NumberFormat the new DateTimeFormatter is immutable
		// and thread-safe.
